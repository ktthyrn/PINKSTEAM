    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const gameData = {
                ...
                popularity: formData.popularity === '' ? null : Number(formData.popularity),
                    ...
                    <div className="col-12 col-lg-5 mb-4 mb-lg-0 d-flex">
                        <div className="card admin-games-form-card flex-fill">
                            <div className="admin-games-card-body">
                                ...
                                <form onSubmit={editingId ? handleUpdate : handleSubmit} className="admin-games-modern-form">
                                        ...
                                        <div className="col-12 col-lg-8 mx-auto">
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <textarea
                                                    ...
                                                    style={{ resize: 'vertical', borderRadius: 12, boxShadow: '0 2px 8px #e7548033' }}
                                                />
                                            </div>
                                            ...
                                            <div className="mb-3">
                                                ...
                                                {formData.image && (formData.image.startsWith('http://') || formData.image.startsWith('https://')) && (
                                                    <div style={{ marginBottom: '1rem', textAlign: 'center' }}>
                                                        <img src={formData.image} alt="Vista previa" style={{ maxWidth: '100%', maxHeight: '200px', borderRadius: '12px', border: '1px solid #ccc', boxShadow: '0 2px 8px #e7548033', transition: 'all 0.3s' }} />
                                                    </div>
                                                )}
                                                {formData.image && !(formData.image.startsWith('http://') || formData.image.startsWith('https://')) && (
                                                    <div style={{ marginBottom: '1rem', textAlign: 'center' }}>
                                                        <img src={`${process.env.PUBLIC_URL}/games/${formData.image}`} alt="Vista previa" style={{ maxWidth: '100%', maxHeight: '200px', borderRadius: '12px', border: '1px solid #ccc', boxShadow: '0 2px 8px #e7548033', transition: 'all 0.3s' }} />
                                                    </div>
                                                )}
                                            </div>
                                            <div className="row g-2">
